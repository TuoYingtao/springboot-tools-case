...
(
    ...
    enable_base_service  tinyint COMMENT '是否启用三层架构基类 0：启用 1：关闭',
    common_package_path  varchar(500) COMMENT '工具包路径',
    create_time    datetime COMMENT '创建时间',
    update_time    datetime COMMENT '更新时间',
    primary key (id),
...
(
    ...
    date_fill       varchar(20) COMMENT '日期填充 DEFAULT、JSON_FORMAT、DATE_FORMAT、JSON_DATE_FORMAT',
    date_format     varchar(20) COMMENT '日期格式 yyyy-MM-dd HH:mm:ss、yyyy-MM-dd HH:mm、yyyy-MM-dd、yyyy-MM',
    time_zone       varchar(20) COMMENT '时区 GMT+8、GMT、UTC',
