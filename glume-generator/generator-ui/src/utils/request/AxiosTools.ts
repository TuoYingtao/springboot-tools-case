 ...
 * 下载方法
 */
export function downloadGet(url: string, params?: Params, fileName?: string, options?: AxiosOptionsConfig): Promise<void> {
 ...
 * 下载方法
 */
export function downloadPost(url: string, params?: Params, fileName?: string, options?: AxiosOptionsConfig): Promise<void> {
 ...
 * 下载方法
 */
async function download(method: string, url: string, params?: Params, fileName?: string, options?: AxiosOptionsConfig): Promise<void> {
